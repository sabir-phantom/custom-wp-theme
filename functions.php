...
function customtheme_register_styles() {
    ...
    wp_enqueue_style("customtheme-font", "https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.13.0/css/all.min.css", array(), '5.13.0', 'all' );
}
...
function customtheme_register_scripts() {
    ...
    wp_enqueue_script('customtheme-bootstrap', get_template_directory_uri()."/assets/js/main.js", array(), '1.0', true) ;
}
